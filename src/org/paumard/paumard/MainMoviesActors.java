...
package org.paumard.paumard;

import org.paumard.paumard.model.Actor;
import org.paumard.paumard.model.Movie;
...
public class MainMoviesActors {
    ...
    public static void main(String... args) throws IOException {
        ...
        Map<String, Integer> stat1 = movies.stream()
                                    .collect(Collectors.toMap(movie -> movie.title()+movie.releaseYear(), movie -> movie.actors().size()));
